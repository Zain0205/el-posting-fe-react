...
function Recomendation() {
  return (
    <section className="hidden fixed right-0 bg-background h-screen border-gray-900 shadow-lg lg:flex py-3 lg:top-0 lg:w-96 lg:flex-col lg:py-5 lg:justify-between z-100">
